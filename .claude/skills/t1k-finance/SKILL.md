...
keywords: [finance, cfo, investor report, investor update, monthly finance, board deck, p&l, pnl, profit and loss, runway, burn, cash flow, unit economics, ltv, cac, roas, client concentration, hhi, revenue concentration, cohort retention, mrr, nrr, churn, arpu, rule of 40, burn multiple, fx rate, currency conversion, financial model, kpi dashboard]
argument-hint: "[audience: investor|internal|board] [topic?]"
effort: medium
version: 0.21.2
...
# TheOneKit Finance — CFO-Grade Reporting
...
This skill registers `t1k-finance` in the theonekit-core activation fragment. Keywords (see YAML frontmatter above) auto-activate this skill whenever finance/investor/board/CFO language appears in the user prompt.
