...
This skill was seeded by studying four public Claude Code / AgentSkill repos (cfo-stack, AnythingButLaw, ai-ceo-framework, cloud-finops-skills) plus industry CFO playbooks (Sequoia, YC, a16z, Brex, ProfitWell). None of those sources' content is copied; patterns and structure are original adaptations.
