...
Task("t1k-fullstack-developer", "Fix Issue A. Claim tasks via TaskUpdate.", "Fix A")
Task("t1k-fullstack-developer", "Fix Issue B. Claim tasks via TaskUpdate.", "Fix B")
```
...
| 2+ independent issues | Task trees per issue + t1k-fullstack-developer agents |
