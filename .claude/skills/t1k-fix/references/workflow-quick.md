...
Use `t1k-code-reviewer` subagent for quick review.
...
**If autonomous mode:** Ask to commit via `t1k-git-manager` subagent if score >= 9.0
...
| 4 | `t1k-code-reviewer` subagent |
| 5 | `t1k-git-manager` subagent |
