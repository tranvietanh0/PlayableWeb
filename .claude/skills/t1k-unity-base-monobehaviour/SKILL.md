---
name: t1k:unity:base:monobehaviour
...
Core reference for MonoBehaviour-based development in Unity 6 (non-DOTS). For ECS, see `dots-ecs`.
...
- `dots-ecs` — DOTS/ECS alternative (use `dots-implementer` agent)
