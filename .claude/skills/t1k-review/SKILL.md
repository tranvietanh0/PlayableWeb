...
| **Skill review (auto)** | Diff includes `.claude/skills/*/SKILL.md` or `.claude/skills/*/references/*.md` | invoke `t1k-skill-creator` (owns Skillmark + decision-tree + line-cap conventions) |
