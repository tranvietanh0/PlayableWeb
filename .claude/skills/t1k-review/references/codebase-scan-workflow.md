...
### Research
* Use 2 `t1k-researcher` subagents in parallel to search up to 5 sources
* Keep every research report concise (≤150 lines)
* Use `/t1k:scout` skill invocation to search the codebase

### Code Review
* Use multiple `t1k-code-reviewer` subagents in parallel to review code
...
### Plan
* Use `t1k-planner` subagent to analyze reports and create improvement plan
