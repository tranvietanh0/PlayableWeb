...
**Ultrathink** to exhaustively list ALL potential edge cases, then dispatch parallel `t1k-code-reviewer` agents to verify: <scope>$ARGUMENTS</scope>
...
- Ask: "Commit? [Y/n]" → use `t1k-git-manager`
