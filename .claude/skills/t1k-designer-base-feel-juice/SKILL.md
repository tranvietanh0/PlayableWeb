---
name: t1k:designer:base:feel-juice
...
effort: high
context: fork
keywords: [juice, screen shake, hit stop, hit-stop, particles, particle burst, animation curves, easing, squash stretch, coyote time, camera punch, time slow, chromatic aberration, vignette, hit flash, damage numbers, knockback]
version: 1.12.0
