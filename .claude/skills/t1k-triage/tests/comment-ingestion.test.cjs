 ...
 *
 * Purpose: prove that t1k:triage's SKILL.md and companion fixture encode the
 ...
 * runs inside Claude at triage time (no standalone binary), so these tests:
 ...
 *
 * Run: node .claude/skills/t1k-triage/tests/comment-ingestion.test.cjs
 */
