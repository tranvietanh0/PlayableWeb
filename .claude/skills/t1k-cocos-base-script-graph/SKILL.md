---
name: t1k:cocos:base:script-graph
...
keywords: [cocos, cocos-creator, ccclass, script-graph, class-diagram, ts-morph, dependency-cruiser, scene, prefab, uuid]
effort: medium
t1k-adapter:
  engine: cocos
  ...
  priority: 100
version: 1.7.0
origin: theonekit-cocos
repository: The1Studio/theonekit-cocos
module: base
protected: false
---
...
Cocos Creator 3.x diagram adapter for the T1K diagram toolchain. Produces four diagram types from Cocos project sources:
