...
## Cross-reference
For full Tell/Use/Counter on detected pattern: t1k-negotiation/references/pattern-catalog.md
For specific tactics to deploy: t1k-negotiation/references/technique-library.md
For phase-aware moves: t1k-negotiation/references/phase-playbook.md
```
...
## Linking back to `t1k-negotiation`

The full 20-pattern catalog with detailed Tell/Use/Counter and worked examples lives in `t1k-negotiation/references/pattern-catalog.md`. **This skill (`t1k-contract-review`) does NOT duplicate the catalog** — it references it.

For:
- Pattern theory + counters → `t1k-negotiation/references/pattern-catalog.md`
- Named techniques (80+) → `t1k-negotiation/references/technique-library.md`
- Phase-specific guidance → `t1k-negotiation/references/phase-playbook.md`
- Cultural overlay → `t1k-negotiation/references/cultural-map.md`

Use Mode 7 for **identification** (which pattern is this?). Then jump to `t1k-negotiation` for **strategic counter** (what's my play?).
