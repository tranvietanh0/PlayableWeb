...
- For pattern recognition before drafting reply: `t1k-negotiation/references/pattern-catalog.md`
- For phase-aware closing tactics: `t1k-negotiation/references/phase-playbook.md` Phase 4
