#!/usr/bin/env python3
# t1k-origin: kit=theonekit-core | repo=The1Studio/theonekit-core | module=t1k-maintainer | protected=true
"""
...
origin: [TODO: kit-name e.g. theonekit-core — REQUIRED for new files; CI overwrites with canonical value post-merge]
repository: [TODO: org/repo e.g. The1Studio/theonekit-core — optional; CI overwrites]
module: [TODO: module-name e.g. t1k-base — optional; CI auto-resolves from path]
protected: [TODO: true|false — true for theonekit-core, false elsewhere; CI overwrites]
---
